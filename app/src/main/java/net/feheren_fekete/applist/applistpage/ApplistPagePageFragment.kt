...
//            }, 200)
    ...
    private fun removeShortcut(shortcutItem: StartableItem) {
        GlobalScope.launch {
            applistRepo.removeShortcut(shortcutItem.id)
        }
    }
    ...
    private fun renameApp(startableItem: StartableItem) {
        ...
        ApplistDialogs.textInputDialog(
                ...
                { newAppName ->
                    GlobalScope.launch {
                        applistRepo.setStartableCustomName(startableItem.id, newAppName)
                    }
                })
    }
    ...
    private fun renameSection(sectionItem: SectionItem) {
        ...
        ApplistDialogs.textInputDialog(
                ...
                { newSectionName ->
                    ...
                    GlobalScope.launch {
                        applistRepo.setSectionName(sectionId, newSectionName)
                    }
                })
    }
    ...
    private fun deleteSection(sectionItem: SectionItem) {
        ...
        ApplistDialogs.questionDialog(
                ...
                {
                    GlobalScope.launch {
                        applistRepo.removeSection(sectionItem.id)
                    }
                },
                {
                    // Nothing.
